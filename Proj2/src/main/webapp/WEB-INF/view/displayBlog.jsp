...
<html lang="en">
  	<head>
    	...
    	<script>
 			var v=${bdata};
 			angular.module('myApp4',[]).controller('customersCtrl4', function($scope)
    		{    	
    			console.log(v);
    			$scope.bgls = v;
    	  	});
	...
	<body>
		...
		<div class="container">
			<div class="row">
				<div class="container" ng-app="myApp4" ng-controller="customersCtrl4">
  					<div class="row">
					...
					<div ng-repeat="c in bgls | filter:na"> 
							...
							<div class="row">
    							...
    							<div class="row">
    								<div class="pull-right">
    									<a type="button" href="displayUserBlog?s={{c.busername}}" class="btn btn-info">User's posts</a>
    									<a type="button" href="cmtBlog?id={{c.blogid}}" class="btn btn-info">Comment blog</a>
    									<a type="button" href="viewProfile?s={{c.busername}}" class="btn btn-info">view profile</a>
    								</div>
    							</div>      
   							</div>
     					</div>     
    					...
    					<br />
  						...
  						<div class="alert alert-info">
  							<div class="row">
    							<a type="button" href="editBlog?id={{c.blogid}}" class="btn btn-info btn-md">Edit</a>
    							<a type="button" href="deleteBlog?id={{c.blogid}}" class="btn btn-info btn-md">Delete</a>
   								<a type="button" href="mail" class="btn btn-info btn-md">Email</a>
    							<div class="pull-right">    
   									<a href="listCmtBlog?s={{c.btag}}" class="btn btn-info btn-md">view comment</a>
  								</div>
  							</div>
     					</div>
		...
		<section class="section-divider textdivider divider20">	</section>
