...
<html lang="en">
  	<head>
    	...
    	<link rel="stylesheet" href="<c:url value='/resources/bootstrap-3.3.6-dist/bootstrap-3.3.6-dist/css/bootstrap.css.map'/> "/>  
     	...
     	<script>
  			var v=${tbdata};
 			angular.module('myApp6',[]).controller('customersCtrl6', function($scope)
    		{    	
    			console.log(v);
    			$scope.tbgls = v;
    	  	});
	...
	<body>
		...
		<div class="container">
			<div class="row">
				<div class="container" ng-app="myApp6" ng-controller="customersCtrl6">
  					<div class="row">
					...
					<div ng-repeat="c in tbgls | filter:na">
		...
		<section class="section-divider textdivider divider21">	</section>
